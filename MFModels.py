...
class AnnoyClassifier:
    def __init__(self, n_neighbors=5, mac_neighbors=None, metric='euclidean',
                 sakoe_chiba_radius=1, n_trees=-1, random_seed=1992):
    ...
    def nn_dtw(self, tv):
        ...
        for nn in self.curr_nn_inds:
            ...
            cost = dtw(tr_v, tv, global_constraint="sakoe_chiba",
                       sakoe_chiba_radius=self.sakoe_chiba_radius)
            costs.append(cost)
